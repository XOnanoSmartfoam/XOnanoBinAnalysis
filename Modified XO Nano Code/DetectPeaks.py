...
# # ```python
# # ind = detect_peaks(x, mph=None, mpd=1, threshold=0, edge='rising', kpsh=False, valley=False, show=False, ax=None)
# # ```
...
# get_ipython().magic('timeit detect_peaks(x)')
# print('\nPerformance (using the minimum peak distance parameter):')
# print('detect_peaks(x, mpd=10)')
# get_ipython().magic('timeit detect_peaks(x, mpd=10)')
...
# get_ipython().magic('loadpy ./../functions/detect_peaks.py')
